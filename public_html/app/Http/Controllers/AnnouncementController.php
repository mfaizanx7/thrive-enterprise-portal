...
//    }
    ...
    public function getemployee(Request $request)
    {
        ...
        {
            $employees = Employee::where($column, '=',$ownerId)->get()->pluck('name', 'id')->toArray();
        }
        else
        {
            $employees = Employee::where($column, '=',$ownerId)->where('department_id', $request->department_id)->get()->pluck('name', 'id')->toArray();
        }
