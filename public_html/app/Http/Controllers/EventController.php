...
class EventController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if(\Auth::user()->can('create event'))
        {
            ...
            $employeeIds = [];
            $employeeIds = array_merge($employeeIds, $departmentEmployee->toArray());
            ...
            foreach ($userarr as $key => $notifyto) {
                Utility::makeNotification($notifyto, 'event', $dataarr, $event->id, 'Announce a ' . $event->title. ' event', \Auth::user()->name);
            }
