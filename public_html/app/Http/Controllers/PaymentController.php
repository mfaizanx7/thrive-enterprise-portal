...
//            dd($chartAccountId);
            ...
            if ($workflow) {
                ...
                foreach ($workflowaction as $action) {
                    ...
                    if (strtolower('create-payment') == $action->node_id) {
                        ...
                        if ($us_notify == 'true' || $us_approve == 'true') {
                            ...
                            if (count($usr_Notification) > 0) {
                                ...
                                foreach ($usr_Notification as $usrLead) {
                                    ...
                                    if($us_notify == 'true'){
                                        Utility::makeNotification($usrLead,'create_payment',$data,$pay_id,'create Payment');
                                    }elseif($us_approve == 'true'){
                                        Utility::makeNotification($usrLead,'approve_payment',$data,$pay_id,'For Approval Payment');
                                    }
                                }
                            }
                        }
