...
@section('action-btn')
    <div class="float-end">
        <a href="#" data-size="md" data-url="{{ route('clientuser.create') }}" data-ajax-popup="true"  data-bs-toggle="tooltip" title="{{__('Create')}}"  class="btn btn-sm btn-primary">
...
{{--                                            </a>--}}
                                            ...
                                            @can('edit clientuser')
                                                <a href="#!" data-size="md" data-url="{{ route('clientuser.edit',$client->id) }}" data-ajax-popup="true" class="dropdown-item" data-bs-original-title="{{__('Edit User')}}">
