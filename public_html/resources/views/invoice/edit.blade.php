...
@push('script-page')
    ...
    <script>
        ...
        function disabledlist() {
            ...
            const disabledItems = {!! json_encode($disabled) !!}; // Pass the array from PHP
            document.querySelectorAll('.item').forEach(select => { // Loop through all select elements
                disabledItems.forEach(value => {
