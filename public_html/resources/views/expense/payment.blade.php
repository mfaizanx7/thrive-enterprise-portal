{{ Form::open(array('route' => array('expense.payment', $expense->id),'method'=>'post','enctype' => 'multipart/form-data')) }}
    <div class="modal-body">
        <div class="row">
            ...
            <div class="form-group col-md-6">
                ...
                {{ Form::number('amount',$expense->newgetDue(), array('class' => 'form-control','required'=>'required','step'=>'0.01')) }}
