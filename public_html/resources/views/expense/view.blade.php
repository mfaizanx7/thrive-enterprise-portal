                ...
                <div class="card-body">
                    <div class="row timeline-wrapper">
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            ...
                            <h6 class="text-primary my-3">{{__('Create Expence')}}</h6>
                            <p class="text-muted text-sm mb-3"><i class="ti ti-clock mr-2"></i>{{__('Created on ')}}{{\Auth::user()->dateFormat($expense->bill_date)}}</p>
                            @can('edit bill')
                                <a href="{{ route('expense.edit',\Crypt::encrypt($expense->id)) }}" class="btn btn-sm btn-primary" data-bs-toggle="tooltip" data-original-title="{{__('Edit')}}"><i class="ti ti-pencil mr-2"></i>{{__('Edit')}}</a>
                        ...
                        <div class="col-md-6 col-lg-6 col-xl-6">
                            ...
                            @if($expense->status!=4)
                                @can('create payment bill')
                                    <a href="#" data-url="{{ route('expense.payment',$expense->id) }}" data-ajax-popup="true" data-title="{{__('Add Payment')}}" class="btn btn-sm btn-info" data-original-title="{{__('Add Payment')}}"><i class="ti ti-report-money mr-2"></i>{{__('Add Payment')}}</a> <br>
                                @endcan
                            @endif
                                    ...
                                    <div class="table-responsive mt-3">
                                        <table class="table mb-0 table-striped">
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td style="float: right"><b>{{\Auth::user()->priceFormat($expense->getAccountTotal())}}</b></td>
