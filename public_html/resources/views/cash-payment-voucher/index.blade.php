...
@section('page-title')
    {{__('Manage Cash Payment Voucher')}}
@endsection
...
@section('action-btn')
    <div class="float-end">
        @can('create journal entry')
            <a href="{{ route('cash-payment-voucher.create') }}" data-title="{{__('Create New Cash Payment Voucher')}}" data-bs-toggle="tooltip"  title="{{__('Create')}}" class="btn btn-sm btn-primary">
                                    ...
                                    <td>
                                        @can('edit journal entry')
                                            <div class="action-btn bg-primary ms-2">
                                                <a data-title="{{__('Edit Cash Payment Voucher')}}" href="{{ route('cash-payment-voucher.edit',[$journalEntry->id]) }}" class="mx-3 btn btn-sm align-items-center" data-bs-toggle="tooltip" title="{{__('Edit')}}" data-original-title="{{__('Edit')}}">
