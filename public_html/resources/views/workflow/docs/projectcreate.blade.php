...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Manage Project Workflow') }}</li>
@endsection
...
@section('content')
    ...
    <head>
        ...
        <script src="{{ asset('public/workflow/docs/projectscript.js') }}"></script>
    ...
    <body>
        <div class="wrapper">
            <div class="col tab-content active-content">
                <div class="nav-item dropdown">
                    <li data-toggle="collapse" data-target="#project" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content:space-between;">Project <span><i
                                    class="fa fa-chevron-down"></i></span></a>
                    </li>
                    <ul class="sub-menu collapse" id="project">
                    </ul>
                    <li data-toggle="collapse" data-target="#task" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content:space-between;">Task <span><i
                                    class="fa fa-chevron-down"></i></span></a>
                    </li>
                    <ul class="sub-menu collapse" id="task">
                    </ul>
                    <li data-toggle="collapse" data-target="#checklist" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content:space-between;">Checklist <span><i
                                    class="fa fa-chevron-down"></i></span></a>
                    </li>
                    <ul class="sub-menu collapse" id="checklist">
                    </ul>
                    <li data-toggle="collapse" data-target="#bug" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content:space-between;">Bug <span><i
                                    class="fa fa-chevron-down"></i></span></a>
                    </li>
        ...
        <script>
            ...
            var projectColumn = {!! json_encode($projectcolumns) !!};
            var taskColumn = {!! json_encode($taskcolumns) !!};
            var checklistColumn = {!! json_encode($checklistcolumns) !!};
            var bugColumn = {!! json_encode($bugcolumns) !!};
            ...
            function populateDropdowns(dropdownId) {
                ...
                if (dropdownContent) {
                    ...
                    const stages = stagesMap[dropdownId] || [];
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                populateDropdowns('checklist');
                populateDropdowns('bug');
            });
