...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Manage Hrm Workflow') }}</li>
@endsection
...
@section('content')
    ...
    <head>
        ...
        <script src="{{ asset('public/workflow/docs/hrmscript.js') }}"></script>
    ...
    <body>
        <div class="wrapper">
            <div class="col tab-content active-content">
                <div class="nav-item dropdown">
                    <li data-toggle="collapse" data-target="#employee" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Employee <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="employee">
                    </ul>
                    <li data-toggle="collapse" data-target="#payroll" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Payroll <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="payroll">
                    </ul>
                    <li data-toggle="collapse" data-target="#leaves" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Leaves <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="leaves">
                    </ul>
                    {{-- <li data-toggle="collapse" data-target="#performance" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Performance <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="performance">
                    </ul>
                    <li data-toggle="collapse" data-target="#training" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Training <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="training">
                    </ul>
                    <li data-toggle="collapse" data-target="#award" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Award <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="award">
                    </ul>
                    <li data-toggle="collapse" data-target="#transfer" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Transfer <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="transfer">
                    </ul> --}}
                    <li data-toggle="collapse" data-target="#resignation" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Resignation <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="resignation">
                    </ul>
                    <li data-toggle="collapse" data-target="#termination" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Termination <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="termination">
                    </ul>
                    <li data-toggle="collapse" data-target="#warning" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Warning <span><i class="fa fa-chevron-down"></i></span>
                        </a>
                    </li>
                    <ul class="sub-menu collapse" id="warning">
                    </ul>
                    {{-- <li data-toggle="collapse" data-target="#promotion" class="collapsed mt-2">
                        <a href="#" style="display: flex; justify-content: space-between;">
                            Promotion <span><i class="fa fa-chevron-up"></i></span>
                        </a>
                    </li>
        ...
        <script>
            ...
            var employeeColumn = {!! json_encode($employeecolumns) !!};
            var payrollColumn = {!! json_encode($payslipcolumns) !!};
            var leavesColumn = {!! json_encode($leavecolumns) !!};
            var resignationColumn = {!! json_encode($resignationcolumns) !!};
            var terminationColumn = {!! json_encode($terminationcolumns) !!};
            var warningColumn = {!! json_encode($warningcolumns) !!};
                ...
                if (dropdownContent) {
                    ...
                    const stagesMap = {
                        ...
                        leaves: [{
                            ...
                            {
                                icon: 'fa-check',
                                text: 'Leave Status Update',
                                node: 'leave-status-update'
                            }
                        ],
                        // performance: [{
                        //     icon: 'fa-star',
                        //     text: 'Create Appraisal',
                        //     node: 'create-appraisal'
                        // }],
                        // training: [{
                        ...
                        //     node: 'create-transfer'
                        // }],
                        resignation: [{
                            icon: 'fa-handshake',
                            text: 'Create Resignation',
                            node: 'create-resignation'
                        }],
                        termination: [{
                            icon: 'fa-ban',
                            text: 'Create Termination',
                            node: 'create-termination'
                        }],
                        warning: [{
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                populateDropdowns('payroll');
                populateDropdowns('leaves');
                // populateDropdowns('performance');
                // populateDropdowns('training');
                // populateDropdowns('award');
                // populateDropdowns('transfer');
                populateDropdowns('resignation');
                populateDropdowns('termination');
                populateDropdowns('warning');
                // populateDropdowns('promotion');
            ...
            <div>
              <div class="title-box">
                    ...
                    if (draggedElement) {
                        ...
                        var tabId = draggedElement.closest('ul').id;
            ...
            function addConditionRow(conditionsContainer, clickedNode) {
                ...
                switch (tabidValue) {
                    ...
                    case 'leaves':
                        ...
                        break;
                    case 'resignation':
                        columns = resignationColumn;
                        break;
                    case 'termination':
                        columns = terminationColumn;
                        break;
                    case 'warning':
