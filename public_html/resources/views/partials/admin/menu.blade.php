...
<div class="navbar-wrapper border_bg">
    <div class="m-header main-logo">
        <a href="#" class="b-brand">
            <img src="https://thriveconsulting.global/wp-content/uploads/2023/06/logo-final-1024x493.jpg"
                alt="Thrive Consulting" class="logo logo-lg" style="width: 100%; max-width: 200px; height: auto;">
        </a>
    </div>
    ...
    <div class="navbar-content">
        ...
        @if (\Auth::user()->type != 'client')
            <ul class="dash-navbar">
                ...
                @if (Gate::check('show hrm dashboard') ||
                    ...
                    <li
                        class="dash-item dash-hasmenu
                                ...
                                Request::segment(1) == 'clientspaces-report' || Request::segment(1) == 'vacantspacesreport' || Request::segment(1) == 'meeting-space-report'||Request::segment(1) == 'vacant-report' ||Request::segment(1) == 'spaces-report' || Request::segment(1) == 'asset-report' ||
                        ...
                        <ul class="dash-submenu">
                            ...
                            @endif
                             @if (\Auth::user()->type != 'clientuser')
                                    <li
                                        class="dash-item dash-hasmenu {{ Request::route()->getName() == 'workspace.dashboard' || Request::segment(1) == 'clientspaces-report' || Request::segment(1) == 'vacantspacesreport' ||Request::segment(1) == 'vacant-report'||Request::segment(1) == 'spaces-report'  || Request::segment(1) == 'meeting-space-report' || Request::segment(1) == 'asset-report'  ? ' active dash-trigger' : '' }}">
                                        <a class="dash-link" href="#">{{ __('WorkSpace') }}<span
                                                class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                        <ul class="dash-submenu">
                                            <li
                                                class="dash-item {{ \Request::route()->getName() == 'workspace.dashboard' ? ' active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('workspace.dashboard') }}">{{ __(' Overview') }}</a>
                                            </li>
                                            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'spaces-report' || Request::segment(1) == 'clientspaces-report' || Request::segment(1) == 'vacantspacesreport' || 
                                            Request::segment(1) == 'meeting-space-report' 
                                            ||Request::segment(1) == 'vacant-report' 
                                            || Request::segment(1) == 'asset-report' ? 'active dash-trigger' : '' }}"
                                                href="#spaces-report" data-toggle="collapse" role="button"
                                                aria-expanded="{{ Request::segment(1) == 'spaces-report' ? 'true' : 'false' }}">
                                                <a class="dash-link" href="#">{{ __('Reports') }}<span
                                                        class="dash-arrow"><i data-feather="chevron-right"></i></span></a>
                                                <ul class="dash-submenu">
                                                    <li
                                                        class="dash-item {{ request()->is('spaces-report') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('spacesReport') }}">{{ __('Spaces') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('clientspaces-report') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('clientspaceReport') }}">{{ __('Contracts') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('vacant-report') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('vacantspaceReport') }}">{{ __('Vacant Spaces') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('meeting-space-report') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('meetingspacereport') }}">{{ __('Meeting Space Report') }}</a>
                                                    </li>
                                                    <li
                                                        class="dash-item {{ request()->is('asset-report') ? 'active' : '' }}">
                                                        <a class="dash-link"
                                                            href="{{ route('assetreport') }}">{{ __('Assests Report') }}</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                ...
                @if (\Auth::user()->type == 'clientuser')
                    <li class="dash-item dash-hasmenu ">
                        <a href="{{ route('clientuser.dashboard') }}"
                            class="dash-link {{ Request::segment(1) == 'clientuser-dashboard' ? ' active' : '' }}">
                            <span class="dash-micon"><i class="ti ti-home"></i>
                            </span><span class="label">{{ __('Dashboard') }}</span>
                        </a>
                    </li>
                @endif
                        ...
                        <li
                            ...
                            <ul class="dash-submenu">
                                ...
                                @if (Gate::check('manage leave') || Gate::check('manage attendance'))
                                    <li
                                        class="dash-item dash-hasmenu  {{ Request::segment(1) == 'leave' || Request::segment(1) == 'leaveto' || Request::segment(1) == 'attendanceemployee' ? 'active dash-trigger' : '' }}">
                                        ...
                                        <ul class="dash-submenu">
                                           ...
                                           <!-- <li class="dash-item {{ request()->is('leaveto*') ? 'active' : '' }}">
                                                <a class="dash-link"
                                                    href="{{ route('leaveto') }}">{{ __('Report To Leaves') }}</a>
                                            </li> -->
                ...
                @if (Gate::check('manage customer') ||
                    ...
                    <li
                        class="dash-item dash-hasmenu
                                     ...
                                     Request::route()->getName() == 'recurring-invoices.index' || 
                                     Request::route()->getName() == 'recurring-invoices.create' || 
                                     Request::route()->getName() == 'recurring-invoices.edit' || 
                                     Request::route()->getName() == 'recurring-invoices.show'
                                         ? ' active dash-trigger'
                                         : '' }}">
                        ...
                        <ul class="dash-submenu">
                            ...
                            @if (Gate::check('manage customer') ||
                                    ...
                                    Gate::check('manage credit note'))
                                <li
                                    class="dash-item dash-hasmenu {{ Request::segment(1) == 'customer' || Request::segment(1) == 'proposal' || Request::segment(1) == 'invoice' || Request::segment(1) == 'revenue' || Request::segment(1) == 'credit-note' || Request::segment(1) == 'recurring-invoices' ? 'active dash-trigger' : '' }}">
                                    ...
                                    <ul class="dash-submenu">
                                        ...
                                        <li
                                            class="dash-item {{ Request::route()->getName() == 'recurring-invoices.index' || Request::route()->getName() == 'recurring-invoices.create' || Request::route()->getName() == 'recurring-invoices.edit' || Request::route()->getName() == 'recurring-invoices.show' ? ' active' : '' }}">
                                            <a class="dash-link"
                                                href="{{ route('recurring-invoices.index') }}">{{ __('Recurring Invoices') }}</a>
                                        </li>
                                        <li
                                            ...
                                            <ul id="voucher" class="dash-submenu">
                                                <li class="dash-item ">
                                                    <a class="dash-link {{ Request::route()->getName() == 'bank-recipt-voucher.edit' || Request::route()->getName() == 'bank-recipt-voucher.create' || Request::route()->getName() == 'bank-recipt-voucher.index' || Request::route()->getName() == 'bank-recipt-voucher.show' ? ' active' : '' }}"
                                                        href="{{ route('bank-recipt-voucher.index') }}">{{ __('Bank Receipt') }}</a>
                                                </li>
                                                <li class="dash-item ">
                                                ...
                                                <li class="dash-item ">
                                                    <a class="dash-link {{ Request::route()->getName() == 'cash-recipt-voucher.edit' || Request::route()->getName() == 'cash-recipt-voucher.create' || Request::route()->getName() == 'cash-recipt-voucher.index' || Request::route()->getName() == 'cash-recipt-voucher.show' ? ' active' : '' }}"
                                                        href="{{ route('cash-recipt-voucher.index') }}">{{ __('Cash Receipt') }}</a>
                                                </li>
                                                <li class="dash-item ">
                    ...
                    <ul class="dash-submenu">
                        ...
                        @can('manage bug report')
                            <li class="dash-item {{ request()->is('bugs-report*') ? 'active' : '' }}">
                                <a class="dash-link" href="{{ route('bugs.view', 'list') }}">{{ __('Issue') }}</a>
                            </li>
                        @endcan
                        @can('manage project task')
                                ...
                                <ul class="dash-submenu">
                                    ...
                                    @can('manage bug status')
                                        <li
                                            ...
                                            <a class="dash-link"
                                                href="{{ route('bugstatus.index') }}">{{ __('Issue Status') }}</a>
                                        </li>
                                    @endcan
                                </ul>
                            </li>
        ...
        <!--------------------- Start Booking Managaement System ----------------------------------->
        @if (!empty($userPlan) && $userPlan->pos == 1)
            @if (Gate::check('manage warehouse') ||
                ...
                <li class="dash-item dash-hasmenu {{Request::segment(1) == 'bookingcalendar' || Request::segment(1) == 'booking' ? ' active dash-trigger' : '' }}">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-calendar"></i></span><span
                            class="dash-mtext">{{ __('Bookings') }}</span><span class="dash-arrow"><i
                                data-feather="chevron-right"></i></span></a>
                    <ul class="dash-submenu {{ Request::segment(1) == 'warehouse' }}">
                        <li class="dash-item  ">
                        <a class="dash-link"
                            href="{{ route('booking.calendar', ['all']) }}">{{ __('Calender') }}</a>
                    </li>

                    <li class="dash-item ">
                        <a class="dash-link {{ Request::route()->getName() == 'booking' ? 'active' : '' }}"
                            href="{{ route('booking.index') }}">{{ __('List') }}</a>
                    </li>
                    </ul>
                </li>
            @endif
        ...
        @if (\Auth::user()->type == 'clientuser')
            <li class="dash-item dash-hasmenu ">
                <a href="{{ route('booking.calendar', ['all']) }}"
                    ...
                    <span class="dash-micon"><i class="ti ti-calendar"></i>
        ...
        <!--------------------- End Booking Managaement System----------------------------------->
        
        <!--------------------- Start WorkSpace Managaement System ----------------------------------->

        @if( Gate::check('view space') || Gate::check('view spacetype') || Gate::check('view spacetype') || Gate::check('manage ismail') || Gate::check('manage vistor') )
            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'spacetype' || Request::segment(1) == 'space' || Request::segment(1) == 'account-assets-client' || Request::segment(1) == 'isvisitor' || Request::segment(1) == 'ismail' ? ' active dash-trigger' : '' }}">
                <a href="#!" class="dash-link "><span class="dash-micon"><i
                            class="ti ti-box"></i></span><span
                        class="dash-mtext">{{ __('Workspace') }}</span><span class="dash-arrow"><i
                            data-feather="chevron-right"></i></span></a>
                <ul class="dash-submenu">
                    @can('view spacetype')
                        <li class="dash-item ">
                            <a class="dash-link {{ Request::segment(1) == 'spacetype' ? 'active' : '' }}"
                                href="{{ route('spacetype.index') }}">{{ __('Space Type') }}</a>
                        </li>
                    @endcan
                    @can('view space')
                        <li class="dash-item">
                    ...
                    @can('manage assets')
                        <li class="dash-item">
                            <a class="dash-link  {{ request()->is('account-assets-client*') ? 'active' : '' }}"
                                href="{{ route('account-assets-client.index') }}">{{ __('Asset Setup ') }}</a>
                        </li>
                    @endcan
                    @can('manage vistor')
                        <li class="dash-item ">
                            <a class="dash-link {{ Request::segment(1) == 'isvisitor' ? ' active' : '' }}"
                                href="{{ route('isvisitor.index') }}">{{ __('Visitor') }}</a>
                        </li>
                    @endcan
                    @can('manage ismail')
                        <li class="dash-item ">
        ...
        @endif
          @if( ( Auth::user()->is_admin == 1) && Auth::user()->type != 'company' )
            <li class="dash-item dash-hasmenu {{ Request::segment(1) == 'invoice' ? ' active dash-trigger' : '' }}">
                <a href="#!" class="dash-link "><span class="dash-micon"><i
                            class="ti ti-layers-difference"></i></span><span
                        class="dash-mtext">{{ __('Invoices') }}</span><span class="dash-arrow"><i
                            data-feather="chevron-right"></i></span></a>
                <ul class="dash-submenu">
                    @if(Auth::user()->is_admin == 1 || Gate::check('view invoice'))
                        <li class="dash-item ">
                            <a class="dash-link {{ Request::segment(1) == 'invoice' ? 'active' : '' }}"
                                href="{{ route('invoice.index') }}">{{ __('Invoice') }}</a>
                        </li>
                       <!-- <li class="dash-item ">
                            <a class="dash-link {{ Request::segment(1) == 'contract' ? 'active' : '' }}"
                                href="{{ route('contract.index') }}">{{ __('Contract') }}</a>
                        </li> -->
                    @endif
                </ul>
        ...
        <!--------------------- End WorkSpace Managaement System----------------------------------->
            ...
            <li
                ...
                <ul class="dash-submenu">
                    ...
                    @can('manage branch')
                        @if (Auth::user()->type == 'company')
                            <li
                                class="dash-item {{ Request::route()->getName() == 'companies.index' || Request::route()->getName() == 'companies.create' || Request::route()->getName() == 'companies.edit' ? ' active' : '' }} ">
                                <a class="dash-link" href="{{ route('companies.index') }}">{{ __('Companies') }}</a>
                            </li>
                        @endif
                    @endcan
                    @can('manage branch')
                    ...
                    @can('manage clientuser')
                        <li class="dash-item ">
                            <a class="dash-link {{ Request::route()->getName() == 'clientuser.index' || Request::segment(1) == 'clientuser' || Request::route()->getName() == 'clientuser.edit' ? ' active' : '' }}"
                                href="{{ route('clientuser.index') }}">{{ __('Client') }}</a>
                        </li>
                    @endcan
                    {{--                                    @can('manage user') --}}
