<div class="card sticky-top" style="top:30px">
    <div class="list-group list-group-flush" id="useradd-sidenav">
       ...
       <!-- <a href="{{ route('stages.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'stages.index' ) ? ' active' : '' }}">{{__('Deal Stages')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a> -->
        ...
        <a href="{{ route('assign-target.index') }}" class="list-group-item list-group-item-action border-0 {{ (Request::route()->getName() == 'assign-target.index' ) ? 'active' : '' }}   ">{{__('Set Target')}}<div class="float-end"><i class="ti ti-chevron-right"></i></div></a>
    </div>
</div>
