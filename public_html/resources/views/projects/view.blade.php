...
{{--            </a>--}}
        ...
        @endcan
        <a href="{{ route('project-srs', $project->id) }}"data-bs-toggle="tooltip" title="{{__('Project SRS')}}" class="btn btn-sm btn-primary">
            {{__('SRS')}}
        </a>
        {{-- <a href="#" data-size="xl" data-url="{{ route('project-srs', $project->id) }}" data-ajax-popup="true" data-bs-toggle="tooltip" title="{{__('Project SRS')}}" class="btn btn-sm btn-primary">
            {{__('SRS')}}
        </a> --}}
        @can('edit project')
