                                ...
                                <tbody>
                                    ...
                                    @foreach ($accountArrays as $accounts)
                                        @foreach ($accounts as $account)
                                            ...
                                            @if ($account->reference == 'Journal' || $account->reference == 'BRV' || $account->reference == 'BPV' || $account->reference == 'CRV' || $account->reference == 'CPV')

                                                <tr>
                                                    <td>{{ $account->account_name }}</td>
                                                    <td>{{ '-' }}
                                                    </td> 
                                                    <td>@if($account->reference == 'CRV') {{ AUth::user()->CRVNumberFormat($account->reference_id)}} @elseif($account->reference == 'BRV') {{ AUth::user()->BRVNumberFormat($account->reference_id)}}
                                                        @elseif($account->reference == 'CPV') {{ AUth::user()->CPVNumberFormat($account->reference_id)}} @elseif($account->reference == 'BPV') {{ AUth::user()->BPVNumberFormat($account->reference_id)}}
                                                        @else  {{ AUth::user()->journalNumberFormat($account->reference_id)}} @endif
                                                    </td>
