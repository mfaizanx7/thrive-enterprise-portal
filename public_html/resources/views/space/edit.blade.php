    ...
    <div class="row">
        <div class="row">
            ...
            <div class="form-group col-6">
                ...
                {{ Form::select('pricing_type', ['hour' => 'Hour', 'day' => 'Day', 'month' => 'Month'], null, ['class' => 'form-control', 'required' => 'required', 'id' => 'pricing_type']) }}
            </div>
            <div class="form-group col-6">
            ...
            <div class="form-group col-6" id="per_seat_container">
                <div class="form-check form-switch mt-4">
                    ...
                    <input type="checkbox" class="form-check-input" name="per_seat_pricing" id="per_seat_pricing"
                        value="1" {{ $space->per_seat_pricing ? 'checked' : '' }}>
