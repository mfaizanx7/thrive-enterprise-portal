                                            ...
                                            <td>
                                                <div class="row ">
                                                    ...
                                                    @if(in_array('show '.$module,(array) $permissions))
                                                        ...
                                                        @endif
                                                    @endif
                                                    @if(in_array('company permission '.$module,(array) $permissions))
                                                        @if($key = array_search('company permission '.$module,$permissions))
                                                            <div class="col-md-3 custom-control custom-checkbox">
                                                                {{Form::checkbox('permissions[]',$key,$role->permission, ['class'=>'form-check-input staff_checkall isscheck_'.str_replace(' ', '', str_replace('&', '', $module)),'id' =>'permission'.$key])}}
                                                                {{Form::label('permission'.$key,'Company Permission',['class'=>'custom-control-label'])}}<br>
                                                            </div>
                                                        @endif
                                                    @endif
                                                    {{-- @if (in_array('company permission ' . $module, (array) $permissions))
