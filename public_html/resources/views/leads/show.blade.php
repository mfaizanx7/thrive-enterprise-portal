...
@section('content')
    @php
        $customData = App\Models\CustomField::getData($lead, 'lead');
    @endphp
    <div class="row">
        <div class="col-sm-12">
            <div class="row">
                <div class="col-xl-3">
                    <div class="card sticky-top" style="top:30px">
                        <div class="list-group list-group-flush" id="lead-sidenav">
                            ...
                            @if(Auth::user()->type != 'client')
                                <a href="#custom" class="list-group-item list-group-item-action border-0">{{__('Custom Field')}}
                                    <div class="float-end"><i class="ti ti-chevron-right"></i></div>
                                </a>
                            @endif
