...
@section('page-title')
    {{__('Cash Receipt Voucher Detail')}}
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item"><a href="{{route('dashboard')}}">{{__('Dashboard')}}</a></li>
    <li class="breadcrumb-item">{{__('Vouchers')}}</li>
    <li class="breadcrumb-item"><a href="{{route('cash-recipt-voucher.index')}}">{{__('Cash Receipt Voucher Entry')}}</a></li>
